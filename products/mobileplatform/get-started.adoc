...
6. In 1) Choose a Template screen, choose Hello World Project by clicking _choose._
...
*Note:* The top right “development” box is red, indicated app is not running. 
